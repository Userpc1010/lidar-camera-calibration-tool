...
#include <factors/general_factor.hpp>
#include <registration/rejector.hpp>
#include <registration/reduction.hpp>
#include <registration/optimizer.hpp>
#include <registration/termination_criteria.hpp>
#include <registration/registration_result.hpp>
